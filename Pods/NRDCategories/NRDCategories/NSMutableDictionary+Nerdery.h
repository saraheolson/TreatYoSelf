...
/**
*  Sets the given object, or [NSNull null] if it is @c nil, for the given key in the reciever.
* 
*  This is useful when generating dictionaries to turn into JSON.
*
*  @param anObject The object to set, or @c nil.
