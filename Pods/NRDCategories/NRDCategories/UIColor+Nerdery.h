...
/**
 ...
 @param rgbValue The value is in the the format @c 0xRRGGBB
 @return A UIColor with the appropriate color
 @author Jon Rexeisen
*/
+ (UIColor *)nrd_colorWithHex:(uint)rgbValue;
...
/**
 ...
 @author Jon Rexeisen
 */
+ (UIColor *)nrd_colorWithHex:(uint)rgbValue alpha:(float)alpha;
